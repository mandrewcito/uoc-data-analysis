...
```{r}
fligner.test(as.integer(titanicData$Age), as.integer(titanicData$Survived))
```

En ningún caso obtenemos un p valor mayor a 0.05 por loque no aceptamos la hipótesis de que la varianza de ambas muestras es homogénea.
